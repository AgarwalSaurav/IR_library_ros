...
namespace IRlibrary {
	class Planar3R {
		...
		public:
			// Constructors
			Planar3R() : l({0, 0, 0}), q({0, 0, 0}), base({0, 0}) { setM(); setSlist(); wsCalc(); zeroForwardKinematics(); };
			Planar3R(double l1_i, double l2_i, double l3_i) : l({l1_i, l2_i, l3_i}), q({0, 0, 0}), base({0, 0}) { setM(); setSlist(); wsCalc(); zeroForwardKinematics(); };
